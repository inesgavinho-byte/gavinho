      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '32px' }}>
        <div className="card" style={{ padding: '20px' }}>
          ...
          <div style={{ fontSize: '24px', fontWeight: 700 }}>
            {stats.orcamentoTotalProjetos > 0 ? formatCurrency(stats.orcamentoTotalProjetos) : '0 â‚¬'}
          </div>
        </div>
        ...
        <div className="card" style={{ padding: '20px' }}>
          ...
          <div style={{ fontSize: '24px', fontWeight: 700 }}>
            {stats.valorContratadoObras > 0 ? formatCurrency(stats.valorContratadoObras) : '0 â‚¬'}
          </div>
        </div>
        ...
        <div className="card" style={{ padding: '20px' }}>
          ...
          <div style={{ fontSize: '24px', fontWeight: 700, color: 'var(--success)' }}>
            {stats.totalFaturadoObras > 0 ? formatCurrency(stats.totalFaturadoObras) : '0 â‚¬'}
          </div>
        </div>
      </div>
