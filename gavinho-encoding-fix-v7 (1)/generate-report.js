...
async function generateReport(data) {
  ...
  children.push(
    new Paragraph({
      ...
      children: [new TextRun({ 
        text: 'RELATÀ“RIO DE ACOMPANHAMENTO DE OBRA', 
        bold: true, 
        size: 28,
  ...
  children.push(
    new Paragraph({
      ...
      children: [new TextRun({ 
        text: 'IDENTIFICAÀ‡ÀƒO | PROJECT IDENTIFICATION', 
        bold: true, 
        size: 24,
        font: 'Cormorant Garamond',
        color: COLORS.olive
  ...
  if (photoBuffers.length > 0) {
    children.push(
      ...
      new Table({
        ...
        rows: [
          new TableRow({ children: [
            createCell('REGISTO FOTOGRÀFICO | PHOTOGRAPHIC RECORD', { 
              bold: true, 
              shading: COLORS.cream, 
              alignment: AlignmentType.CENTER,
              width: 9360
    ...
    if (problems.length > 0) {
      children.push(
        ...
        new Table({
          ...
          rows: [
            new TableRow({ children: [
              createCell('OBSERVAÀ‡À•ES IMPORTANTES | IMPORTANT REMARKS', { 
                bold: true, 
                shading: COLORS.cream, 
                alignment: AlignmentType.CENTER,
                width: 9360
    ...
    if (nextSteps) {
      children.push(
        ...
        new Table({
          ...
          rows: [
            new TableRow({ children: [
              createCell('PRÀ“XIMOS PASSOS | NEXT STEPS', { 
                bold: true, 
                shading: COLORS.cream, 
                alignment: AlignmentType.CENTER,
                width: 9360
