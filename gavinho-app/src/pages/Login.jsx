  ...
  const handleEmailLogin = async (e) => {
    ...
    try {
      ...
      if (err.message.includes('Invalid login credentials')) {
        ...
        setError('Por favor confirme o seu email')
      } else {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.borderColor = 'var(--stone-dark)'
            }}
            onMouseLeave={(e) => {
          ...
          <p style={{ textAlign: 'center', marginTop: '20px', fontSize: '13px', color: 'var(--brown-light)' }}>
            Ainda não tem conta?{' '}
            <Link to="/registo" style={{ color: 'var(--brown)', fontWeight: 500, textDecoration: 'none' }}>
              Criar Conta
            </Link>
          </p>
        </div>
        ...
        >
          © 2024 GAVINHO Group. Design & Build de Luxo.
        </p>
      </div>
