...
export default function NCSubtab({ obraUuid, obra, currentUser }) {
  return (
    <div style={{ textAlign: 'center', padding: 48, background: '#FFFFFF', borderRadius: 10, border: `1px solid ${colors.border}` }}>
      <AlertTriangle size={48} style={{ color: '#B0ADA3', opacity: 0.4, marginBottom: 16 }} />
      <p style={{ color: '#6B6B6B', fontSize: FONT_SIZES.md, fontFamily: FONTS.body }}>Não Conformidades</p>
