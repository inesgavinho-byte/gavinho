...
export default function MessageList({
  ...
  const isOwnMessage = (post) => checkOwnMessage(post, profile?.id)
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    {showMessageMenu === post.id && (
                      <div style={{
                        ...
                        <button
                          onClick={() => { onReply?.(post); setShowMessageMenu(null) }}
                          style={{
                            width: '100%',
                            display: 'flex',
                            alignItems: 'center',
                        ...
                        <button
                          onClick={() => { onOpenThread?.(post); setShowMessageMenu(null) }}
                          style={{
                            width: '100%',
                            display: 'flex',
                            alignItems: 'center',
                        ...
                        <button
                          onClick={() => { onSaveMessage?.(post); setShowMessageMenu(null) }}
                          style={{
                            width: '100%',
                            display: 'flex',
                            alignItems: 'center',
                        ...
                        <button
                          onClick={() => { onPinMessage?.(post); setShowMessageMenu(null) }}
                          style={{
                            width: '100%',
                            display: 'flex',
                            alignItems: 'center',
                        ...
                        <button
                          onClick={() => { onForward?.(post); setShowMessageMenu(null) }}
                          style={{
                            width: '100%',
                            display: 'flex',
                            alignItems: 'center',
                        ...
                        <button
                          onClick={() => { onCreateTask?.(post); setShowMessageMenu(null) }}
                          style={{
                            width: '100%',
                            display: 'flex',
                            alignItems: 'center',
            ...
            <div style={{ paddingLeft: showAuthor ? '52px' : '0' }}>
              ...
              {editingMessage?.id === post.id ? (
                ...
                <div>
                  ...
                  {isOwnMessage(post) && getReadStatus && (
                    <div style={{
                      display: 'flex',
                      alignItems: 'center',
                      gap: '4px',
      ...
      {posts.length === 0 && (
        <div style={{
          ...
          <p style={{ margin: 0 }}>
            Se o primeiro a publicar neste canal!
          </p>
        </div>
      )}
