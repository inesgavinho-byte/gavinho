        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: '600px', maxHeight: '90vh', overflow: 'auto' }}>
            <div className="modal-header">
              <h3>{editingItem ? 'Editar' : 'Adicionar'} {activeTab === 'materiais' ? 'Material' : activeTab === 'modelos3d' ? 'Modelo 3D' : 'Inspiração'}</h3>
            ...
            <div className="modal-body">
                  ...
                  <div style={{ background: 'var(--cream)', padding: '16px', borderRadius: '12px', marginBottom: '20px' }}>
                    ...
                    <div style={{
                      ...
                      {(tempFileUrl || editingItem?.textura_url) && (
                        <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.3)', borderRadius: '10px' }} />
                      )}
                      <input
                        type="file"
                        accept="image/*"
                      ...
                      />
                      <Upload size={24} style={{ color: (tempFileUrl || editingItem?.textura_url) ? 'white' : 'var(--brown-light)', marginBottom: '8px', position: 'relative', zIndex: 1 }} />
                      <span style={{ fontSize: '13px', color: (tempFileUrl || editingItem?.textura_url) ? 'white' : 'var(--brown-light)', position: 'relative', zIndex: 1 }}>
              ...
              {activeTab === 'modelos3d' && (
                <>
                  {/* Upload Ficheiro + Miniatura */}
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '20px' }}>
                    <div>
                      <label style={{ display: 'block', fontSize: '12px', fontWeight: 500, marginBottom: '8px' }}>Ficheiro 3D</label>
                      <div style={{
                        border: '2px dashed var(--stone)',
                        borderRadius: '12px',
                        padding: '16px',
                    ...
                    <div>
                      <label style={{ display: 'block', fontSize: '12px', fontWeight: 500, marginBottom: '8px' }}>Miniatura</label>
                      <div style={{
                        border: '2px dashed var(--stone)',
                        borderRadius: '12px',
                        padding: '16px',
                        textAlign: 'center',
                        background: (tempMiniaturaUrl || editingItem?.miniatura_url) ? `url(${tempMiniaturaUrl || editingItem?.miniatura_url}) center/cover` : 'var(--cream)',
                        position: 'relative',
                        minHeight: '80px'
                      }}>
                        <input
                        ...
                        {!(tempMiniaturaUrl || editingItem?.miniatura_url) && (
                          <>
                            <Image size={20} style={{ color: 'var(--brown-light)', marginBottom: '4px' }} />
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                    <div>
                      ...
                      <input type="text" value={modelo3dForm.nome} onChange={e => setModelo3dForm({ ...modelo3dForm, nome: e.target.value })} className="form-input" placeholder="Ex: Sofá Chester" />
                    </div>
                    <div>
                      <label style={{ display: 'block', fontSize: '12px', fontWeight: 500, marginBottom: '6px' }}>Categoria</label>
                      <select value={modelo3dForm.categoria_id} onChange={e => setModelo3dForm({ ...modelo3dForm, categoria_id: e.target.value })} className="form-input">
                        <option value="">Selecionar...</option>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                    <div>
                      <label style={{ display: 'block', fontSize: '12px', fontWeight: 500, marginBottom: '6px' }}>Formato</label>
                      <select value={modelo3dForm.formato} onChange={e => setModelo3dForm({ ...modelo3dForm, formato: e.target.value })} className="form-input">
                        <option value="">Selecionar...</option>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                    <div>
                      <label style={{ display: 'block', fontSize: '12px', fontWeight: 500, marginBottom: '6px' }}>Largura (cm)</label>
                      <input type="number" step="0.1" value={modelo3dForm.largura_cm} onChange={e => setModelo3dForm({ ...modelo3dForm, largura_cm: e.target.value })} className="form-input" />
                    </div>
                    <div>
                      <label style={{ display: 'block', fontSize: '12px', fontWeight: 500, marginBottom: '6px' }}>Altura (cm)</label>
                      <input type="number" step="0.1" value={modelo3dForm.altura_cm} onChange={e => setModelo3dForm({ ...modelo3dForm, altura_cm: e.target.value })} className="form-input" />
                    </div>
                    <div>
                      <label style={{ display: 'block', fontSize: '12px', fontWeight: 500, marginBottom: '6px' }}>Profundidade (cm)</label>
                      <input type="number" step="0.1" value={modelo3dForm.profundidade_cm} onChange={e => setModelo3dForm({ ...modelo3dForm, profundidade_cm: e.target.value })} className="form-input" />
                    </div>
                  </div>

                  <div style={{ marginBottom: '16px' }}>
                    <label style={{ display: 'block', fontSize: '12px', fontWeight: 500, marginBottom: '6px' }}>Descrição</label>
                    <textarea value={modelo3dForm.descricao} onChange={e => setModelo3dForm({ ...modelo3dForm, descricao: e.target.value })} className="form-input" rows={2} />
                  </div>
                </>
              )}
